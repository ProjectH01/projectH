	...
	<div class="container">
	 <div class="navbar navbar-default">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./company/company_main.com">Project H</a>
        </div>
		...
		<div class="well">
			...
			<div class="row">
				<ul>
					...
					<li>
						<div class="col-sm-3">
							<a onclick="location='company_ask.com';">
								<div>
									<div>${event_req_listcount}</div>
									<h3>이벤트 상담요청</h3>
									<p></p>
								</div>
							</a>
					...
					<li>
						<div class="col-sm-3">
							<a onclick="location='company_cash.com';">
								<div>
									<div>${company_total_cash}</div>
									<h3>현재 충전금액</h3>
									<p></p>
								</div>
							</a>
